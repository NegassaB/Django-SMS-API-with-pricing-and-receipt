...
from commons.models import SMSMessages, SMSUser
...
vamos = SMSUser.objects.get(username="VamosUser1")
habesha = SMSUser.objects.get(username="HabeshaUser1")
...
def resender():
  ...
  for s in queryset:
    if s.sending_user == vamos or s.sending_user == habesha:
